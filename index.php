...
<footer class="footer-distributed" style="background-color:black" id="aboutUs">
	...
	<div class="footer-left">
		<h3 style="font-family: 'Times New Roman', cursive;">AgroProducts &copy; </h3>
		<!--	<div class="logo">
	...
	<div class="footer-center">
		<div>
			...
			<p style="font-size:20px">AgroProducts<span>India</span></p>
		</div>
		<div>
		...
		<div>
			...
			<p style="font-size:20px"><a style="color:white">admin@agroproducts.com</a></p>
		</div>
	</div>

	<div class="footer-right">
		<p class="footer-company-about" style="color:white">
			<span style="font-size:20px"><b>About AgroProducts</b></span>
			AgroProducts is e-commerce platform for Farming Products...
		</p>
